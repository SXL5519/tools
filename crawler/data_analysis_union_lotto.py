...
"""
##
# path=os.path.split(sys.path[0])[0]###读取当前文件的根目录
path=readConfig.path+"/data_file/union_lotto.csv"
print(path)
df =pd.read_csv(path,header=0,encoding='ANSI')##header=0表示csv文件第一行为行名
